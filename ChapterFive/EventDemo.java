//Ahmed Aldhaheri
//Carlys event price with methods program chapter five
...
public class EventDemo
{
   ...
   public static void main(String[] args)
   {
      ...
      displayEventPrice(guest1, eventNumber1, event1);
   ...
   public static void displayEventPrice(int guest, String eventNum, Event event)
   {
      ...
      //display events passed and check fo larger and return it
